            ...
            async with ClientSession(
                ...
                try:
                    search_result = await client.call_tool(
                        "search_flights", {"origin": "SFO", "destination": "NYC"}
                    )
                ...
                try:
                    booking_result = await client.call_tool(
                        "create_booking",
                        {"flight_id": "UA789", "passenger_name": "Sarah Wilson"},
                    )
                ...
                try:
                    ...
                    if airport_result.contents:
                        ...
                        print(
                            f"   ✅ Retrieved {len(content)} characters of airport data"
                        )
                    print()
                except Exception as e:
                    print(f"   ❌ Error: {e}")
                ...
                try:
                    disruption_result = await client.get_prompt(
                        "handle_disruption",
                        {"original_flight": "UA789", "reason": "mechanical issue"},
                    )
